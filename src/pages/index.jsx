...
const Home = () => {
  ...
  return (
    <main className="md:px-10">
      ...
      <div className="mobile:px-0 sm:px-6 lg:px-20 xl:px-52 xxl:px-80 my-10 mb-3 grid grid-cols-12 grid-rows-6 sm:min-h-[400px] md:min-h-[520px] sm:gap-2 md:gap-4">
        <div
